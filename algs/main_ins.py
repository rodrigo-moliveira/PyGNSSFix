...
from src.modules.ins.ins_alg_manager import InsAlgorithmManager
...
def main():
    ...
    try:
        ...
        print("To run `main_ins.py` please do:\n\t$ python main_ins.py <path_to_config>")
        exit(-1)
    ...
    try:
        alg_mng = InsAlgorithmManager(output_dir)

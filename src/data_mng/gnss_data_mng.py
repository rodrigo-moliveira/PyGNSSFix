...
from src.data_mng.sim_data import SimulationData


class GnssDataManager(Container):
    __slots__ = ["time", "navigation_data", "observation_data",
    ...
    def __init__(self):
        ...
        # Reference time
        self.time = SimulationData(name="time", description="sample time", units=["s"], legend=["time"])

        # Input Navigation Data
        self.navigation_data = SimulationData(name="navigation_data", description="Input Navigation Data")
        # Input Observation Data
        self.observation_data = SimulationData(name="observation_data", description="Input Observation Data")

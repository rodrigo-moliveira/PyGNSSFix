...
class SimpleEopDatabase:
    ...
    def __init__(self):
        ...
        leap_file = config_dict.get("inputs", "leap_file", fallback="geo_time_data/eop/tai-utc.dat")
        finals_file = config_dict.get("inputs", "finals_file", fallback="geo_time_data/eop/finals1980.all")

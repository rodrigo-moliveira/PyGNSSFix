...
def gpt3_5_fast(mjd=None, lat=None, lon=None, h_ell=None, it=None, grid=None):
    ...
    for k in range(0, nstat):
        ...
        if bilinear == 0:
            ...
            dTl = dT_grid.iloc[indx, 0] + dT_grid.iloc[indx, 1] * cosfy + dT_grid.iloc[indx, 2] * sinfy + dT_grid.iloc[
            ...
            # hydrostatic and wet coefficients ah and aw
            ahl = ah_grid.iloc[indx, 0] + ah_grid.iloc[indx, 1] * cosfy + ah_grid.iloc[indx, 2] * sinfy + ah_grid.iloc[
                indx, 3] * coshy + ah_grid.iloc[indx, 4] * sinhy
            awl = aw_grid.iloc[indx, 0] + aw_grid.iloc[indx, 1] * cosfy + aw_grid.iloc[indx, 2] * sinfy + aw_grid.iloc[
                indx, 3] * coshy + aw_grid.iloc[indx, 4] * sinhy
            # water vapour decrease factor la
            lal = la_grid.iloc[indx, 0] + la_grid.iloc[indx, 1] * cosfy + la_grid.iloc[indx, 2] * sinfy + la_grid.iloc[
                indx, 3] * coshy + la_grid.iloc[indx, 4] * sinhy
            # mean temperature of the water vapor Tm
            Tml = Tm_grid.iloc[indx, 0] + Tm_grid.iloc[indx, 1] * cosfy + Tm_grid.iloc[indx, 2] * sinfy + Tm_grid.iloc[
